...
venue: "Software Carpentry in R <br> QUT Gardens Point, GP-P504"        # brief name of host site without address (e.g., "Euphoric State University")
address: "QUT Gardens Point, GP-P504"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "9th June 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am-5:00pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-06-09      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-06-10        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Heidi Perrett","Marieke Frassl", "Atefeh Taherian Fard", "Ido Bar"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Malindrie Dharmaratne", "Malindrie Dharmaratne"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
